...
declare module '@slack/client' {
  ...
  interface WebApiChat {
    ...
    meMessage(
      channel: string,
      text: string,
      callback: (err: Error, result: ChatMeMessageResult) => void,
    ): void
    ...
    postMessage(
      channel: string,
      text: string,
      callback: (err: Error, result: ChatPostMessageResult) => void,
    ): void
    postMessage(
      channel: string,
      text: string,
    ...
    update(
      ...
      channel: string,
      text: string,
      callback: (err: Error, result: ChatUpdateResult) => void,
    ): void
    update(
      ts: string,
      channel: string,
      text: string,
      opts: ChatUpdateParams,
      callback: (err: Error, result: ChatUpdateResult) => void,
    ): void
    update(
      ts: string,
